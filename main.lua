...
function Flings.Backflip()
    ...
    local bodyAngularVelocity = Instance.new("BodyAngularVelocity")
    bodyAngularVelocity.AngularVelocity = humanoidRootPart.CFrame.RightVector * -20
...
local flingList = {
    ...
    {"🚀 前方に飛ぶ", Flings.FlingForward, Color3.fromRGB(255, 150, 100)},
    {"👥 周囲を浮かせる", Flings.FloatNearby, Color3.fromRGB(150, 255, 150)},
    {"🎯 対象を飛ばす", Flings.FlingTarget, Color3.fromRGB(255, 100, 150)},
    {"🎲 ランダム飛行", Flings.RandomFling, Color3.fromRGB(200, 100, 255)},
    {"🌀 回転浮遊", Flings.SpinFloat, Color3.fromRGB(100, 255, 255)},
    {"🌙 月面ジャンプ", Flings.MoonJump, Color3.fromRGB(200, 200, 255)},
    {"💥 爆発飛行", Flings.ExplosiveFling, Color3.fromRGB(255, 100, 100)},
    {"☁️ スカイロケット", Flings.SkyRocket, Color3.fromRGB(150, 200, 255)},
    {"🤸 バックフリップ", Flings.Backflip, Color3.fromRGB(255, 200, 100)},
}
